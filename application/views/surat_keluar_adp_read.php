<div id="page-wrapper" >
		...
		<object data="<?php echo base_url('uploads/surat_keluar_adp/'.$dokumen2)?>" type="application/pdf" width="100%" height="700px">
			<p>It appears you don't have a PDF plugin for this browser.
			No biggie... you can <a href="<?php echo base_url('uploads/surat_keluar_adp/'.$dokumen2)?>" download>click here to
			download the PDF file.</a></p>
		</object>
		</td>
		</tr>
		<tr><td><b>Download</b></td><td><a href="<?php echo base_url('uploads/surat_keluar_adp/'.$dokumen2)?>" download>Link Download</a></td></tr>
