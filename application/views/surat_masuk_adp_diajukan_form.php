<div id="page-wrapper" >
		...
		<div class="form-group">
                <label for="int">Indeks Surat</label>
                <input type="text" class="form-control" value="<?php echo $indeks; ?>" readonly/>
            </div>
	    <div class="form-group">
                <label for="int">Kode Surat</label>
                <input type="text" class="form-control" value="<?php echo $kode; ?>" readonly/>
            </div>
	    <div class="form-group">
	    ...
	    <input type="hidden" name="status" value="Surat Masuk" /> 
