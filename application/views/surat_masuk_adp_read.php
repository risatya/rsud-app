<div id="page-wrapper" >
		...
		<object data="<?php echo base_url('uploads/surat_masuk_adp/'.$dokumen)?>" type="application/pdf" width="100%" height="700px">
			<p>It appears you don't have a PDF plugin for this browser.
			No biggie... you can <a href="<?php echo base_url('uploads/surat_masuk_adp/'.$dokumen)?>" download>click here to
